...
namespace Beam\BeamCore\Actions;
...
class Config
{
    public static function publish(string $pwd, string $filepath): bool
    {
        try {
            ...
            file_put_contents(appBasePath() . 'beam.yaml', $yamlContent);
    ...
    public static function get(string $key, mixed $default = null): mixed
    {
        try {
            /** @var array $content */
            $content = Yaml::parseFile(appBasePath() . 'beam.yaml');
    ...
    {
        return file_exists(appBasePath() . 'beam.yaml');
    }
}
